...
import { BrainCircuit, Eye, EyeOff, Loader2, ShieldAlert, CheckCircle2, GraduationCap, Lock, KeyRound, ArrowLeft } from "lucide-react";
...
export default function AuthPage() {
  ...
  const handleVerifyOtp = async () => {
    ...
    if (error) {
      ...
      toast({ title: "Verified! ✅", description: "You're now signed in securely." });
    }
  };
        ...
        <div className="w-full max-w-[400px] space-y-8">
          ...
          <div className="text-center lg:text-left">
            ...
            <h1 className="font-heading text-2xl font-bold text-foreground">
              {step === "otp" ? "Verify OTP" : isSignUp ? "Create Account" : "Welcome Back"}
            </h1>
              ...
              {!isSignUp && (
                <>
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center text-xs"><span className="bg-background px-3 text-muted-foreground">or sign in securely with</span></div>
                  </div>

                  <Button
                    variant="outline"
                    className="w-full h-11 border-accent/30 hover:bg-accent/5"
                    onClick={handleSendOtp}
                    disabled={otpSending || isEmailBlocked || !email}
                  >
                    {otpSending ? (
